...
# Build flags
JAVAC_FLAGS     = -d classes -sourcepath src
...
PACKAGES = \
	src.dcsft.schedule \
	src.dcsft.schedule.parent \
	src.dcsft.schedule.winnertree \
	src.dcsft.schedule.tasks
...
#package targets
src.dcsft : $(call PACKAGE_OBJS,src.dcsft)
src : $(call PACKAGE_OBJS,src)
src.dcsft.schedule : $(call PACKAGE_OBJS,src.dcsft.schedule)
src.dcsft.schedule.parent : $(call PACKAGE_OBJS,src.dcsft.schedule.parent)
src.dcsft.schedule.winnertree : $(call PACKAGE_OBJS,src.dcsft.schedule.winnertree)
src.dcsft.schedule.tasks : $(call PACKAGE_OBJS,src.dcsft.schedule.tasks)
